rocket88.Rectangle = Class.extend({

	init: function(x, y, width, height) {

		// Public properties
		this.origin 	= new rocket88.Point(x, y);
		this.size 		= new rocket88.Size(width, height);
	...
	clone: function() {
		return new rocket88.Rectangle(this.origin.x, this.origin.y, this.size.width, this.size.height);
	},
